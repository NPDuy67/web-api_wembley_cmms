...
{
    public class MaintenanceResponsesQueryHandler : IRequestHandler<MaintenanceResponsesQuery, QueryResult<MaintenanceResponseViewModel>>
    {
        ...
        public async Task<QueryResult<MaintenanceResponseViewModel>> Handle(MaintenanceResponsesQuery request, CancellationToken cancellationToken)
        {

...
{
    public class CorrectionsQueryHandler : IRequestHandler<CorrectionsQuery, QueryResult<CorrectionViewModel>>
    {
        ...
        public async Task<QueryResult<CorrectionViewModel>> Handle(CorrectionsQuery request, CancellationToken cancellationToken)
        {
            ...
            {
                queryable = queryable.Where(x => x.CorrectionId.StartsWith(request.IdStartedWith));
            }

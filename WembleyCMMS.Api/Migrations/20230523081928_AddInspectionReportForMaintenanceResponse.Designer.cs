...
namespace WembleyCMMS.Api.Migrations
{
    ...
    [Migration("20230523081928_AddInspectionReportForMaintenanceResponse")]
    partial class AddInspectionReportForMaintenanceResponse
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WembleyCMMS.Domain.AggregateModels.KitTestAggregate.KitTest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WembleyCMMS.Domain.AggregateModels.MaterialAggregate.Material", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WembleyCMMS.Domain.AggregateModels.MaterialHistoryCardAggregate.MaterialHistoryCard", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("MaterialHistoryCards");
                });
            ...
            modelBuilder.Entity("WembleyCMMS.Domain.AggregateModels.MaterialRequestAggregate.MaterialRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WembleyCMMS.Domain.AggregateModels.MoldAggregate.Mold", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WembleyCMMS.Domain.AggregateModels.MoldInforAggregate.MoldInfor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WembleyCMMS.Domain.AggregateModels.ProductAggregate.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WembleyCMMS.Domain.AggregateModels.StandardAggregate.Standard", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WembleyCMMS.Domain.AggregateModels.EquipmentAggregate.Equipment", b =>
                {
                    ...
                    b.HasOne("WembleyCMMS.Domain.AggregateModels.WorkingTimeAggregate.WorkingTime", null)
                        .WithMany("Equipments")
            ...
            modelBuilder.Entity("WembleyCMMS.Domain.AggregateModels.EquipmentMaterialAggregate.EquipmentMaterial", b =>
                {
                    b.HasOne("WembleyCMMS.Domain.AggregateModels.EquipmentAggregate.Equipment", null)
                        .WithMany("Materials")
                    ...
                    b.HasOne("WembleyCMMS.Domain.AggregateModels.MoldAggregate.Mold", null)
                        .WithMany("Materials")
            ...
            modelBuilder.Entity("WembleyCMMS.Domain.AggregateModels.ImageAggregate.Image", b =>
                {
                    b.HasOne("WembleyCMMS.Domain.AggregateModels.MaintenanceRequestAggregate.MaintenanceRequest", null)
                        .WithMany("Images")
                    ...
                    b.HasOne("WembleyCMMS.Domain.AggregateModels.MoldInforAggregate.MoldInfor", null)
                        .WithMany("Images")
                        .HasForeignKey("MoldInforId");

                    b.HasOne("WembleyCMMS.Domain.AggregateModels.StandardAggregate.Standard", null)
                        .WithMany("Images")
            ...
            modelBuilder.Entity("WembleyCMMS.Domain.AggregateModels.MaintenanceRequestAggregate.MaintenanceRequest", b =>
                {
                    ...
                    b.HasOne("WembleyCMMS.Domain.AggregateModels.MoldAggregate.Mold", "Mold")
                        .WithMany()
                        .HasForeignKey("MoldId");
            ...
            modelBuilder.Entity("WembleyCMMS.Domain.AggregateModels.MoldInforAggregate.MoldInfor", b =>
                {
                    b.HasOne("WembleyCMMS.Domain.AggregateModels.StandardAggregate.Standard", "Standard")
                        .WithMany()
                        .HasForeignKey("StandardId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WembleyCMMS.Domain.AggregateModels.StandardAggregate.Standard", b =>
                {
                    b.HasOne("WembleyCMMS.Domain.AggregateModels.KitTestAggregate.KitTest", "KitTest")
                        .WithMany()
